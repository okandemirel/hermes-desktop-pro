export default {
  ...
  migrationDetected: "Legacy Installation Detected",
  migrationDesc:
    "Found a compatible legacy install at <code>{{path}}</code>. You can migrate your configuration, API keys, sessions, and skills to Hermes.",
