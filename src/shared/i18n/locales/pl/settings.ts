export default {
  ...
  migrationDetected: "Wykryto starszą instalację",
  migrationDesc:
    "Znaleziono zgodną starszą instalację w <code>{{path}}</code>. Możesz przenieść konfigurację, klucze API, sesje i umiejętności do Hermes.",
